...
//add_action( 'woocommerce_update_product', 'set_the_state', 10, 2 );
//function set_the_state( $product_id, $product ){
//$vendor = get_wcmp_product_vendors($product_id);
//$v_id = $vendor->id;
//$vendor_state = get_user_meta($v_id, '_vendor_state', true);
//wp_set_object_terms( $product_id, $vendor_state, 'state' );
//}

echo '<p>Hi</p>';            
            
?>
                    <?php esc_html_e( 'Step 2 of 2: Edit Artwork Details', 'dokan-lite' ); ?>
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <?php if ( is_array( $product_types ) ): ?>
                                        <div class="dokan-form-group">
                                        	...
                                        	<!---<p class="mbatt-hint"><b>Hint:</b> hint about variable products goes here.</p>--->
                                        </div>
                                    <?php endif; ?>
 ...
 -->
                            <div class="mbatt-dokan-product-description">
                                <h2><i class="fa fa-align-left" aria-hidden="true"></i> Description / Artwork Story</h2>
                       	        <p class="">“Why did you create this?” “What inspired it?” Help EC promote this and connect with the right buyer by sharing the “WHY” behind this piece.</p>
                            ...
                            <input type="submit" id="mb_dokan_submit" name="dokan_update_product" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'Save Product', 'dokan-lite' ); ?>"/>
