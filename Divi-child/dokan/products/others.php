...
<div class="dokan-other-options dokan-edit-row dokan-clearfix <?php echo esc_attr( $class ); ?>">
    <div class="dokan-section-heading" data-togglehandler="dokan_other_options">
        ...
        <p><?php esc_html_e( 'Publishing and Care Instructions', 'dokan-lite' ); ?></p>
    ...
    <div class="dokan-section-content">
        <div class="dokan-form-group content-half-part mbatt-poppy-note">
            ...
            <?php if ( $post_status != 'pending' ) { ?>
                <?php $post_statuses = apply_filters( 'dokan_post_status', array(
                    ...
                    'draft'   => __( 'HIDDEN DRAFT', 'dokan-lite' )
                ), $post ); ?>
        ...
        <div class="dokan-form-group">
            <label for="_purchase_note" class="form-label"><?php esc_html_e( 'Special Care Instructions', 'dokan-lite' ); ?></label>
