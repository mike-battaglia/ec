...
<?php
	...
	*/
	//add_action( 'dokan_store_profile_saved', array($this,'ec_save_extra_fields_info'));
...
<div class="dokan-form-group mbatt-hidden">
...
<div class="dokan-form-group">
    ...
    <div class="dokan-w4 ajax_prev dokan-text-left" style="margin-left:24%;">
        <input type="submit" id="the-updater" name="dokan_update_store_settings" class="dokan-btn dokan-btn-danger dokan-btn-theme" value="<?php esc_attr_e( 'Update Settings', 'dokan-lite' ); ?>">
    </div>
</div>
...
//mbatt-hide dokan bio
	var mbattXpath = "//label[text()='Biography']";
