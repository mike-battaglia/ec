 ...
 *  /
  ...
  $user_id = $this_user;
  $ship_origin = 'marketship_origin_address';
  $shippo_box = 'shippo_boxes';
  $single = false;
  $origin_meta = get_user_meta( $user_id, $ship_origin, $single );
  $boxes_meta = get_user_meta( $user_id, $shippo_box, $single );
  $origin_jackpot = $origin_meta[0]['street1'];
/*
